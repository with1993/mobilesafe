...
import com.with.mobilesafe76.db.dao.AppLockDao;
...
@SuppressLint("HandlerLeak") public class AppLockActivity extends Activity {
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView == null){
				...
				holder.tv_name = (TextView) convertView.findViewById(R.id.tv_APPname);
