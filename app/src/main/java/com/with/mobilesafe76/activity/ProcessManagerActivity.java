...
import com.with.mobilesafe76.db.domain.ProcessInfo;
...
@SuppressLint("HandlerLeak") public class ProcessManagerActivity extends Activity implements OnClickListener {
